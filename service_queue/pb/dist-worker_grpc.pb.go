...
func (c *judgeServiceClient) Submit(ctx context.Context, in *Submission, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/dist_worker.JudgeService/Submit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *judgeServiceClient) GetJob(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Job, error) {
	out := new(Job)
	err := c.cc.Invoke(ctx, "/dist_worker.JudgeService/GetJob", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _JudgeService_Submit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dist_worker.JudgeService/Submit",
	}
...
func _JudgeService_GetJob_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dist_worker.JudgeService/GetJob",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var JudgeService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "dist_worker.JudgeService",
